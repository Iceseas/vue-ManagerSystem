<template>
  <div>
    ...
    >
      <el-form-item label="主问题">
        <el-input
          v-model="applicationQuestion.fatherQuestion"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="关系模式1">
        <el-input
          v-model="applicationQuestion.Entity1"
          placeholder="格式XX(XX,XX)"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="关系模式2">
        <el-input
          v-model="applicationQuestion.Entity2"
          placeholder="格式XX(XX,XX)"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="关系模式3">
        <el-input
          v-model="applicationQuestion.Entity3"
          placeholder="格式XX(XX,XX)"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="关系模式4">
        <el-input
          v-model="applicationQuestion.Entity4"
          placeholder="格式XX(XX,XX)"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="关系模式5">
        <el-input
          v-model="applicationQuestion.Entity5"
          placeholder="格式XX(XX,XX)"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="子问题1">
        <el-input
          v-model="applicationQuestion.ChildQuestion1"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="子问题2">
        <el-input
          v-model="applicationQuestion.ChildQuestion2"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="子问题3">
        <el-input
          v-model="applicationQuestion.ChildQuestion3"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="子问题4">
        <el-input
          v-model="applicationQuestion.ChildQuestion4"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="子问题5">
        <el-input
          v-model="applicationQuestion.ChildQuestion5"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <!--<el-form-item
  ...
  >
    ...
    <el-button @click.prevent="removeSQL(sql)" style="margin-left:10px">删除</el-button>
      ...
      <el-form-item>
        <el-button type="primary" @click="onAddQuestionSubmit()"
          >提交</el-button
        >
    ...
    >
      <el-form-item label="问题">
        <el-input
          v-model="vacancyQuestion.Question"
          style="width: 400px;"
        ></el-input>
      </el-form-item>
      <el-form-item label="空位1答案">
        <el-input
          v-model="vacancyQuestion.Space1Answer"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="空位2答案">
        <el-input
          v-model="vacancyQuestion.Space2Answer"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="空位3答案">
        <el-input
          v-model="vacancyQuestion.Space3Answer"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="空位4答案">
        <el-input
          v-model="vacancyQuestion.Space4Answer"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="章节">
        <el-cascader
          :options="options"
          v-model="vacancyQuestion.Chapter"
          clearable
        ></el-cascader>
      </el-form-item>
    ...
    <el-form
      ...
      "
      label-position="left"
      ref="singleDecideQuestion"
      :model="singleDecideQuestion"
      label-width="80px"
      size="mini"
    >
      <el-form-item label="问题">
        <el-input
          v-model="singleDecideQuestion.Question"
          style="width: 400px;"
        ></el-input>
      </el-form-item>
      <el-form-item label="选项A">
        <el-input
          v-model="singleDecideQuestion.Item1"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="选项B">
        <el-input
          v-model="singleDecideQuestion.Item2"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="选项C">
        <el-input
          v-model="singleDecideQuestion.Item3"
      ...
      <el-form-item label="选项D">
        <el-input
          v-model="singleDecideQuestion.Item4"
          :disabled="this.$store.state.updateItemDisabled"
          style="width:400px"
        ></el-input>
      </el-form-item>
      <el-form-item label="正确答案">
        <el-radio-group
          style="width:100%"
          v-model="singleDecideQuestion.Answer"
        >
          <el-col :span="3">
      ...
      <el-form-item label="章节">
        <el-cascader
          :options="options"
          v-model="singleDecideQuestion.Chapter"
          clearable
        ></el-cascader>
      </el-form-item>
      <el-form-item label="知识点">
        <el-input
          v-model="singleDecideQuestion.KN"
          style="width: 200px;"
        ></el-input>
      </el-form-item>
      <el-form-item label="难度">
        <el-radio-group
          style="width:100%"
          v-model="singleDecideQuestion.difficulty"
        >
          <el-col :span="3">
            <el-radio-button label="简单"></el-radio-button>
          </el-col>
  ...
  methods: {
    onAddQuestionSubmit() {
      if (this.$store.state.nowQuestionType == "applicationQuestion") {
        ...
        this.$store.state.nowQuestionType.substring(0, 7) == "vacancy"
      ) {
